...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.genre_list_add = QtWidgets.QListWidget(parent=self.add_page)
        self.genre_list_add.setGeometry(QtCore.QRect(120, 190, 101, 70))
        self.genre_list_add.setSelectionMode(QtWidgets.QAbstractItemView.SelectionMode.MultiSelection)
        self.genre_list_add.setObjectName("genre_list_add")

        self.tabWidget.addTab(self.add_page, "Add Song")
        ...
        self.year_in.setGeometry(QtCore.QRect(120, 270, 101, 31))
        font = QtGui.QFont()
        font.setPointSize(11)
        ...
        self.label_14.setGeometry(QtCore.QRect(40, 270, 61, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.year_edit.setGeometry(QtCore.QRect(120, 270, 101, 31))
        font = QtGui.QFont()
        font.setPointSize(11)
        ...
        self.label_47.setGeometry(QtCore.QRect(40, 270, 61, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.genre_list_edit = QtWidgets.QListWidget(parent=self.edit_page)
        self.genre_list_edit.setGeometry(QtCore.QRect(120, 190, 101, 70))
        self.genre_list_edit.setSelectionMode(QtWidgets.QAbstractItemView.SelectionMode.MultiSelection)
        self.genre_list_edit.setObjectName("genre_list_edit")

        self.tabWidget.addTab(self.edit_page, "Edit Song")
        ...
        # Add genres to both lists after they are created
        genres = [
            "Pop", "Rock", "Hip-hop", "Jazz", "Blues", "Classical",
            "K-pop", "Electronic", "Country", "Indie", "R&B", "Soul", "Other"
        ]

        for g in genres:
            self.genre_list_add.addItem(g)
            self.genre_list_edit.addItem(g)
